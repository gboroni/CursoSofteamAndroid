 ...
 */
public class CustomAdapterLocais extends ArrayAdapter<Local> {

    private  Context ctx;

    public CustomAdapterLocais(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public CustomAdapterLocais(Context context, int resource, List<Local> items) {
