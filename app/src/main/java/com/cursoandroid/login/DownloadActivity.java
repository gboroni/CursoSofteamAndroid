...
public class DownloadActivity extends AppCompatActivity {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            btnPlayMusic.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    File file = new File(Environment.getExternalStorageDirectory().getPath()+"/jai_ho4.mp3");
        ...
        class DownloadMusicfromInternet extends AsyncTask<String, String, String> {
            ...
            protected String doInBackground(String... f_url) {
                ...
                try {
                    ...
                    OutputStream output = new FileOutputStream(Environment.getExternalStorageDirectory().getPath()+"/jai_ho4.mp3");
        ...
        protected void playMusic(){
            ...
            Uri myUri1 = Uri.parse(Environment
                    .getExternalStorageDirectory().getPath()+ "/jai_ho4.mp3");
